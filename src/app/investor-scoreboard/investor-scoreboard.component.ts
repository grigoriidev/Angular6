...
@Component({
  selector: 'app-investor-scoreboard',
  templateUrl: './investor-scoreboard.component.html',
  styleUrls: ['./investor-scoreboard.component.css'],
  providers: [AuthService]
})
export class InvestorScoreboardComponent implements OnInit {
