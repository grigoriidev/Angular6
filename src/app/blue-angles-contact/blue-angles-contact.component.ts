...
@Component({
    selector: 'app-blue-angles-contact',
    templateUrl: './blue-angles-contact.component.html',
    styleUrls: ['./blue-angles-contact.component.css'],
    providers: [HttpService, AuthService]
})
export class BlueAnglesContactComponent implements OnInit {
    model1: any = {};
    validation: any;
    office_state1: any = 'Select State';
    calendarOptions: {};
