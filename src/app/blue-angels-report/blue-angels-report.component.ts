...
@Component({
  selector: 'app-blue-angels-report',
  templateUrl: './blue-angels-report.component.html',
  styleUrls: ['./blue-angels-report.component.css'],
  providers: [AuthService]
})
export class BlueAngelsReportComponent implements OnInit {
