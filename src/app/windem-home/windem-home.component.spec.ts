...
import { WindemHomeComponent } from './windem-home.component';

describe('WindemHomeComponent', () => {
  let component: WindemHomeComponent;
  let fixture: ComponentFixture<WindemHomeComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ WindemHomeComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(WindemHomeComponent);
