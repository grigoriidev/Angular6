...
@Component({
  selector: 'app-state-candidate-events',
  templateUrl: './state-candidate-events.component.html',
  styleUrls: ['./state-candidate-events.component.css'],
  providers: [AuthService]
})
export class StateCandidateEventsComponent implements OnInit {
