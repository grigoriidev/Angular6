...
@Component({
  selector: 'app-state-candidate-contact',
  templateUrl: './state-candidate-contact.component.html',
  styleUrls: ['./state-candidate-contact.component.css'],
  providers: [HttpService, AuthService]
})
export class StateCandidateContactComponent implements OnInit {
