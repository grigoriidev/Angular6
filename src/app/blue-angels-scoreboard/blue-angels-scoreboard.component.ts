...
@Component({
  selector: 'app-blue-angels-scoreboard',
  templateUrl: './blue-angels-scoreboard.component.html',
  styleUrls: ['./blue-angels-scoreboard.component.css'],
  providers: [AuthService]
})
export class BlueAngelsScoreboardComponent implements OnInit {
